...
class Practical_11 {
    ...
    ExecutionException {
    Triplet<String, Integer, Character> p1 =Triplet.of("GRISHA", 26, 'F');
    Triplet<String, Integer, Character> p2 =Triplet.of("MANSI", 20, 'F');
    Triplet<String, Integer, Character> p3 =Triplet.of("KRISHNA", 26, 'F');
